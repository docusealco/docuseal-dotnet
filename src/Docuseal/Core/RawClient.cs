...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::Docuseal.Core.ApiResponse> SendRequestAsync(
        global::Docuseal.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::Docuseal.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::Docuseal.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::Docuseal.Core.BaseRequest request)
    {
