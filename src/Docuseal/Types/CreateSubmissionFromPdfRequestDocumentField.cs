...
[Serializable]
public record CreateSubmissionFromPdfRequestDocumentField : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<CreateSubmissionFromPdfRequestDocumentFieldArea>? Areas { get; set; }
