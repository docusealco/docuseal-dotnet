...
[Serializable]
public record GetTemplatesResponseDataItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<TemplateSchemaDocument> Schema { get; set; } =
        new List<TemplateSchemaDocument>();

    /// <summary>
    /// List of fields to be filled in the template.
    /// </summary>
    [JsonPropertyName("fields")]
    public IEnumerable<TemplateField> Fields { get; set; } = new List<TemplateField>();
    ...
    public required GetTemplatesResponseDataItemSource Source { get; set; }
    ...
    public required TemplateAuthor Author { get; set; }
