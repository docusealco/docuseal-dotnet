...
/// </summary>
[Serializable]
public record CreateTemplateDocumentFieldPreferencesParams : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public CreateTemplateDocumentFieldPreferencesParamsFontType? FontType { get; set; }

    /// <summary>
    /// Font family of the field value.
    /// </summary>
    [JsonPropertyName("font")]
    public CreateTemplateDocumentFieldPreferencesParamsFont? Font { get; set; }

    /// <summary>
    /// Font color of the field value.
    /// </summary>
    [JsonPropertyName("color")]
    public CreateTemplateDocumentFieldPreferencesParamsColor? Color { get; set; }

    /// <summary>
    /// Field box background color.
    /// </summary>
    [JsonPropertyName("background")]
    public CreateTemplateDocumentFieldPreferencesParamsBackground? Background { get; set; }

    /// <summary>
    /// Horizontal alignment of the field text value.
    /// </summary>
    [JsonPropertyName("align")]
    public CreateTemplateDocumentFieldPreferencesParamsAlign? Align { get; set; }

    /// <summary>
    /// Vertical alignment of the field text value.
    /// </summary>
    [JsonPropertyName("valign")]
    public CreateTemplateDocumentFieldPreferencesParamsValign? Valign { get; set; }
    ...
    public CreateTemplateDocumentFieldPreferencesParamsCurrency? Currency { get; set; }
