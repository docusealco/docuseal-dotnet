...
[Serializable]
public record CreateTemplateFromDocxRequestDocumentField : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<CreateTemplateFromDocxRequestDocumentFieldArea>? Areas { get; set; }
