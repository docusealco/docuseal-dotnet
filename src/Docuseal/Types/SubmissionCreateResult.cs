...
public record SubmissionCreateResult : IJsonOnDeserialized
{
    ...
    public required SubmissionCreateResultSource Source { get; set; }

    /// <summary>
    /// The order of submitters.
    /// </summary>
    [JsonPropertyName("submitters_order")]
    public required SubmissionCreateResultSubmittersOrder SubmittersOrder { get; set; }

    /// <summary>
    /// The status of the submission.
    /// </summary>
    [JsonPropertyName("status")]
    public required SubmissionCreateResultStatus Status { get; set; }
