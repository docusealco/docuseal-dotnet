...
public partial interface IDocusealClient
{
    ...
    /// </summary>
    WithRawResponseTask<SubmissionCreateOneoffResult> CreateSubmissionFromPdfAsync(
    ...
    /// </summary>
    WithRawResponseTask<SubmissionCreateOneoffResult> CreateSubmissionFromDocxAsync(
    ...
    /// </summary>
    WithRawResponseTask<SubmissionCreateOneoffResult> CreateSubmissionFromHtmlAsync(
    ...
    /// </summary>
    WithRawResponseTask<SubmissionCreateResult> CreateSubmissionAsync(
